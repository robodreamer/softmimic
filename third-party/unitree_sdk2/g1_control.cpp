...
std::array<float, G1_NUM_MOTOR> Kp{
    200, 150, 150, 200, 20, 20,      // legs
    200, 150, 150, 200, 20, 20,      // legs
    200, 200, 200,                   // waist
    40, 40, 40, 40,  5, 5, 5,  // arms
    40, 40, 40, 40,  5, 5, 5,  // arms
};
...
class G1Control {
 ...
 public:
  ...
  void JoystickStep() {
    ...
    rc_command.right_upper_switch = gamepad.R1.pressed;
    rc_command.left_upper_switch = gamepad.L1.pressed;
    rc_command.left_lower_left_switch = gamepad.X.pressed;
